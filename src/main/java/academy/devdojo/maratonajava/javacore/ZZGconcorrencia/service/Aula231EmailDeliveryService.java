...
public class Aula231EmailDeliveryService implements Runnable {
    private final Aula231Members members;

    public Aula231EmailDeliveryService(Aula231Members members) {
